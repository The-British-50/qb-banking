local Translations = {
    error = {
        ...
        givedirty = "Usage /givedirty [ID] [AMOUNT]",
        wrong_id = "Wrong ID.",
    ...
    success = {
        ...
        give_dirty = "Successfully gave $%{cash} to ID %{id}",
        received_dirty = "Successfully received $%{cash} from ID %{id}"
    },
    info = {
        bank_blip = "Bank",
    ...
    command = {
        ...
        givedirty = "Give dirty cash to player."
    }
}
